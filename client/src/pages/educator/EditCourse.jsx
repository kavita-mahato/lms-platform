...
const EditCourse = () => {
    ...
    const handleEditLecture = (chapterId, lectureIndex, lecture) => {
        ...
        setEditLectureDetails({
            ...
            isPreviewAvailable: lecture.isPreviewAvailable,
        });
    };
    ...
    return (
        <div className="min-h-screen bg-linear-to-b from-slate-50 to-white px-4 py-10">
                        ...
                        >
                            ...
                            <label className="flex items-center gap-2 text-sm text-slate-600">
                                <input
                                    type="checkbox"
                                    checked={
                                        editLectureDetails.isPreviewAvailable
                                    }
                                    onChange={(e) =>
                                        setEditLectureDetails({
                                            ...editLectureDetails,
                            ...
                            <div className="flex gap-3 pt-2">
                                <button
                                    onClick={() =>
                                        setEditLectureModal({ show: false })
                                    }
